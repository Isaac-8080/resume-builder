                  ...
                  <div className="mb-10">
                    ...
                    <div className="section__list">
                      ...
                      <div className="mb-10">
                        ...
                        <div className="align-top inline-block w-[60%]">
                          
                          <div className="font-bold">{template.companyName}</div>
                        ...
                        <div className="align-top inline-block w-[39%]">
                          
                          <div className="font-bold">{template.companyRole}</div>
                      ...
                      <div className="mb-10">
                        ...
                        <div className="align-top inline-block w-[60%]">
                          ...
                          <div className="font-bold">{template.companyName2}</div>
                        ...
                        <div className="align-top inline-block w-[39%]">
                          ...
                          <div className="font-bold">{template.company2Role}</div>
                    ...
                    <div className="section__list">
                      ...
                      <div className="mb-10">
                        ...
                        <div className="align-top inline-block w-[60%]">
                          ...
                          <div className="font-bold">{template.institute}</div>
                        ...
                        <div className="align-top inline-block w-[39%]">
                          ...
                          <div className="font-bold">{template.instituteDegree}</div>
                      ...
                      <div className="mb-10">
                        ...
                        <div className="align-top inline-block w-[60%]">
                          ...
                          <div className="font-bold">{template.institute2}</div>
                        ...
                        <div className="align-top inline-block w-[39%]">
                          ...
                          <div className="font-bold">{template.institute2Degree}</div>
                  ...
                  <div className="section last-of-type:mb-0">
                    ...
                    <div className="section__list">
                      ...
                      <div className="mb-10">
                        ...
                        <div className="font-bold">{template.project}</div>
                      ...
                      <div className="mb-10">
                        ...
                        <div className="font-bold">{template.project2}</div>
                        
                        <div className="text">

                          {template.project2Description}
